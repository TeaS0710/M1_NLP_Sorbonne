...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Sorbonne Université"
Config.profilename = "Eduroam sorbonne-universite.fr"
Config.url = "your local eduroam® support page"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.server_match = "radius.sorbonne-universite.fr"
...
Config.user_realm = "sorbonne-universite.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.sorbonne-universite.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@sorbonne-universite.fr"
